...
Welcome to `self-driving-lab-demo` contributor's guide.
...
If you experience bugs or general issues with `self-driving-lab-demo`, please have a look
...
You can help improve `self-driving-lab-demo` docs by making them more readable and coherent, or
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/self-driving-lab-demo.git
   cd self-driving-lab-demo
   ```
...
5. Install [pre-commit]:
   ...
   `self-driving-lab-demo` comes with a lot of hooks configured to automatically help the
