...
import torch
from ax import Data
from ax.core.objective import Metric, ScalarizedObjective
            ...
            records.append(
                {
                    ...
                    # in practice, mean and sem are looked up based on trial metadata
...
ScalarizedObjective(metrics=[], weights=[0.5, 0.5], minimize=True)
